...
```javascript
dnrm2 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-dnrm2@v0.0.7-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/blas-base-dnrm2/actions/workflows/test.yml/badge.svg?branch=v0.0.7
[test-url]: https://github.com/stdlib-js/blas-base-dnrm2/actions/workflows/test.yml?query=branch:v0.0.7
